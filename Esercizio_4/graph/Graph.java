...
public abstract class Graph <E> {
  ...
  HashMap <Vertex<E>, ArrayList<Edge<E>>> adjList = new HashMap<>();
  ...
  public void addVertex(E elem) throws GraphException {
    ...
    adjList.put(tmp, new ArrayList<Edge<E>>());
    numVertices++;
  }
  ...
  public boolean edgeExists(E elem1, E elem2) throws GraphException {
    ...
    ArrayList<Edge<E>> edgeList = adjList.get(v1); 
  ...
  public ArrayList<Vertex<E>> getAdj(E elem) throws GraphException {
    ...
    ArrayList<Edge<E>> vertexEdges = adjList.get(vertex);
    ArrayList<Vertex<E>> adjList = new ArrayList<>();
    for (Edge<E> edge : vertexEdges)
      adjList.add(edge.getVertex2());
    return adjList;
  }
